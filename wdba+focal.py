...
class TransformerFraudModel(nn.Module):
    def __init__(self, cat_dims, num_dim, embed_dim=128, nhead=8, num_layers=3):
        ...
        self.classifier = nn.Sequential(
            nn.Linear(embed_dim, 256), nn.BatchNorm1d(256), nn.ReLU(), nn.Dropout(0.4),
    ...
    def forward(self, x):
        ...
        return self.classifier(x_out[:, -1, :])
...
if __name__ == '__main__':
    ...
    for epoch in range(1, EPOCH+1):
        ...
        train_ds = FraudHybridDataset(data_values, labels, epoch_indices, WINDOW)
